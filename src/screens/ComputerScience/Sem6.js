...
const Sem6 = () => {
  const [courses, setCourses] = useState([
      ...
      { code: 'Professional Elective III', name: 'Professional Elective III', credits: 3, grade: '' },
      { code: 'Professional Elective IV', name: 'Professional Elective IV', credits: 3, grade: '' },
      { code: 'Professional Elective V', name: 'Professional Elective V', credits: 3, grade: '' },
      { code: 'Professional Elective VI', name: 'Professional Elective VI', credits: 3, grade: '' },
      { code: 'Mandatory Course-II &', name: 'Mandatory Course-II &', credits: 0, grade: '' },
  ]);
