...
const ECE_Sem8 = () => {
    const [courses, setCourses] = useState([
            { code: 'HS3152', name: 'Professional English - I', credits: 3, grade: '' },
            ...
            { code: 'GE3152M', name: 'தமிழர்மரபு /Heritage of Tamils', credits: 1, grade: '' },
            // Practicals
            ...
            { code: 'GE3172', name: 'English Laboratory', credits: 1, grade: '' },          
    ]);
